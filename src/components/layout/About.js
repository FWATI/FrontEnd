                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-12 text-below-abt-img">
                            ...
                            <ul>
                                <li className="bg-dark my-2">Focused on placement oriented courses and skill development</li>
                                <li className="bg-dark my-2">Dedicated Placement division</li>
                                <li className="bg-dark my-2">Experienced Faculty</li>
                                <li className="bg-dark my-2">A broad spectrum of training courses</li>
                                <li className="bg-dark my-2">One of the best multi skill development centre in Delhi</li>
                            </ul>
                            <div className="text-parallel-to-abt-img">
